...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # RoCEnante (b12x.comm.roce) one-shot RoCE all-reduce/all-gather for
    # multi-node TP on DGX Spark (port of local-inference-lab/vllm#597).
    ...
    # Local addition: 0 keeps all-gathers on NCCL while all-reduces use RoCE.
